...
API реализует описанный далее функционал платформы социальной сети для текстовых постов:
...
Запуск сервиса: 
- Установите внешние зависимости (pip install -r requirements.txt) 
- Создайте virtual environment
- Запустите файл run.py
- Сервис запущен на локальном порте http://127.0.0.1:5000
